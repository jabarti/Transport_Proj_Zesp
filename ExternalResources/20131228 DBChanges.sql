...
CREATE  TABLE IF NOT EXISTS `apipo`.`Klient` (
  ...
  `Klientcol` VARCHAR(45) NULL ,
  `Zlecenie_ID_Zlecenia` INT NOT NULL ,
  `osoba_ID_Osoba` INT NOT NULL ,
  PRIMARY KEY (`ID_Klient`, `Zlecenie_ID_Zlecenia`) ,
  INDEX `fk_Klient_Zlecenie1_idx` (`Zlecenie_ID_Zlecenia` ASC) ,
  INDEX `fk_Klient_osoba1_idx` (`osoba_ID_Osoba` ASC) ,
  CONSTRAINT `fk_Klient_Zlecenie1`
