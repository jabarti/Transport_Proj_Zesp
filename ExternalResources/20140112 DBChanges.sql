...
START TRANSACTION;
USE `apipo`;
INSERT INTO `apipo`.`osoba` (`ID_Osoba`, `PESEL`, `Imie`, `Imie2`, `Nazwisko`, `Adres_Ulica`, `Adres_Kod`, `Adres_Miasto`, `Adres_Kraj`, `telefon_kom`, `telefon_kom2`, `telefon stacjonarny`, `FAX`, `email`, `Plec`, `Data_urodzenia`, `RegDate`) VALUES (1, '1111111', 'Ala', 'Ma', 'Kota', 'OM 12', '42-200', 'Częstochowa', 'Polska', '5005050', '1', '0', '0', 'j@wqwqw.pl', 'K', '1975-01-01', '2013-01-01');
