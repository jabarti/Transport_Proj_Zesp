INSERT INTO `bartilev_APIPO`.`osoba` 
...
'Polska', '600000000', NULL, NULL, NULL,'jabarti@wp.pl', 'M', NULL);
...
/**/ 
INSERT INTO `bartilev_APIPO`.`Pracownik` (`ID_Pracownik`, `Stanowisko`, `Pensja`, `data_zatrudnienia`, `data_zwolnienia`, 
`tel_sluzb`, `mail_sluzb`, `osoba_ID_Osoba`) 
VALUES ('1', 'Admin', '1000', '2014-01-01', NULL, NULL, NULL, '2');

INSERT INTO `bartilev_APIPO`.`Pracownik` (`ID_Pracownik`, `Stanowisko`, `Pensja`, `data_zatrudnienia`, `data_zwolnienia`, `tel_sluzb`, `mail_sluzb`, `osoba_ID_Osoba`) 
VALUES (NULL, 'Manager', '2000', '2014-01-07', NULL, '12121212', '12121212', '5');

INSERT INTO `bartilev_APIPO`.`Login` (`ID_Osoba`, `login`, `Password`, `Uprawnienie`) 
...
INSERT INTO `bartilev_APIPO`.`Login` (`ID_Osoba`, `login`, `Password`, `Uprawnienie`) VALUES ('1', 'Alus', 'ff12bbd8c907af067070211d87bdf098be17375b', 'klient');

INSERT INTO `bartilev_APIPO`.`Formularz` (`imie`,`nazwisko`,`email`,`phone`,`zgloszenie`) VALUES ("Bartek","Lewiński","jabarti@wp.pl","600000000","Enter your request here...");

INSERT INTO `bartilev_APIPO`.`Klient` (`ID_Klient`, `osoba_ID_Osoba`) VALUES (NULL, '1');

INSERT INTO `bartilev_APIPO`.`Pracownik` (`ID_Pracownik`, `Stanowisko`, `Pensja`, `data_zatrudnienia`, `data_zwolnienia`, `tel_sluzb`, `mail_sluzb`, `osoba_ID_Osoba`) 
VALUES (NULL, 'Spedytor', '2000', '2014-01-07', NULL, '12121212', 'rab@firma.com', '4');

INSERT INTO `bartilev_APIPO`.`Login` (`ID_Osoba`, `login`, `Password`, `Uprawnienie`) VALUES ('4', 'spedytor', 'ff12bbd8c907af067070211d87bdf098be17375b', 'pracownik');